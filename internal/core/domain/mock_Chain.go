...
func (_m *MockChain) Shutdown() error {
	ret := _m.Called()
...
// MockChain_Shutdown_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Shutdown'
type MockChain_Shutdown_Call struct {
	*mock.Call
}

// Shutdown is a helper method to define mock.On call
func (_e *MockChain_Expecter) Shutdown() *MockChain_Shutdown_Call {
	return &MockChain_Shutdown_Call{Call: _e.mock.On("Shutdown")}
}

func (_c *MockChain_Shutdown_Call) Run(run func()) *MockChain_Shutdown_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockChain_Shutdown_Call) Return(_a0 error) *MockChain_Shutdown_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockChain_Shutdown_Call) RunAndReturn(run func() error) *MockChain_Shutdown_Call {
	_c.Call.Return(run)
	return _c
}
