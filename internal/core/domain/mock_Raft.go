...
import (
	...
	go_pkgdomain "github.com/trevatk/go-pkg/domain"
)
...
func (_m *MockRaft) Notify(ctx context.Context, msg go_pkgdomain.Envelope) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, go_pkgdomain.Envelope) error); ok {
		r0 = rf(ctx, msg)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockRaft_Notify_Call) Run(run func(ctx context.Context, msg go_pkgdomain.Envelope)) *MockRaft_Notify_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(go_pkgdomain.Envelope))
	})
	return _c
}
...
func (_c *MockRaft_Notify_Call) RunAndReturn(run func(context.Context, go_pkgdomain.Envelope) error) *MockRaft_Notify_Call {
	_c.Call.Return(run)
	return _c
}
